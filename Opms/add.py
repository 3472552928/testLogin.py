...
class OpmsAdd():
    def __init__(self,s = requests.session(),host = "http://123.56.170.43:8888" , head={"Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}):
        self.s = s
        self.head = head
        self.host = host
        self.login_post()
    ...
    def login_post(self,username = "libai",pwd = "opms123456"):
    ...
    def add(self):
        ...
        datas = {"name": "测w222222w试", "aliasname": "1222", "started": "2022-06-21", "ended": "2022-06-21", "desc": "111",
                 "id": "0"}
